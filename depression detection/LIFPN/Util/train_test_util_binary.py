...
train_data_set = MyDataset('../processed/train/', '../processed/label.csv')
# dataloader = DataLoader(dataset=train_data_set, batch_size=10, shuffle=True, drop_last=True,
#                         num_workers=0)
# print('start train,the len of dataloader is ', len(dataloader))
print("============")
print(train_data_set)
print(train_data_set.label)
print(train_data_set.transform)
